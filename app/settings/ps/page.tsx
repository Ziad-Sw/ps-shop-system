...
import PsSettingsForm from "@/components/settings/ps-settings-form";
...
export default async function PsSettingsPage() {
  ...
  return (
    <AuthenticatedShell user={user} shopName={shopName} ownerName={ownerName}>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-semibold text-foreground">إعدادات البلايستيشن</h1>
          <p className="mt-2 text-foreground-muted">إدارة أجهزة البلايستيشن وتسعيرها</p>
        </div>
